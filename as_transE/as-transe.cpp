    ...
    void bfgs()
    {
        ...
        int batchsize = fb_h.size()/nbatches;
            for (int epoch=0; epoch<nepoch; epoch++)
            {
                ...
                if(flag==1)
                    {
                    path2="./"+data+"_1/"+"relation2vec."+version;
                    path3="./"+data+"_1/"+"entity2vec."+version;
                    }

                else if(flag==2)
                    {
                    path2="./"+data+"_2/"+"relation2vec."+version;
                    path3="./"+data+"_2/"+"entity2vec."+version;
                    }
               else if(flag==5)
                    {
                    path2="./"+data+"_5/"+"relation2vec."+version;
                    path3="./"+data+"_5/"+"entity2vec."+version;
                    }
                else if(flag==8)
                    {
                    path2="./"+data+"_8/"+"relation2vec."+version;
                    path3="./"+data+"_8/"+"entity2vec."+version;
                    }
                else
...
void prepare()
{
    ...
    char path[20],p1[30],p2[30],p3[30];
    strcpy(path,"../data/");
    ...
    cout<<"length of total train number is "<<total_num<<endl;
    for (int i=0; i<relation_num; i++)
    {
...
int main(int argc,char**argv)
{
    ...
    //cout<<f[0]<<f[1]<<f[3]<<endl;

    //for(int i=0;i<4;i++){
    //flag=f[i];
    prepare();
    train.run(n,rate,margin,method);
    cout<<"result for "<<flag<<" done !!!"<<endl;
//}
